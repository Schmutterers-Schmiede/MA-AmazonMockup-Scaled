...
const TITLE = "Amazon Navigation";

const INSTRUCTIONS: Record<string, string> = {
  baseline: "Visit every tab in the navigation bar at the bottom at least once. When you're done, tap the 'Rate now' button.",
  onehandmode: "Visit every tab in the navigation bar at the bottom least once. When you're done, tap 'Rate now' button.",
  lefthand: "Visit every page using the menu button in the middle of the navigation bar. When you're done, tap 'Rate now' button.",
};
